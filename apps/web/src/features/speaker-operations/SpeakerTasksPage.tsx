...
import { eventLocalDateTimeToIso, formatEventDateTime } from "../../app/event-time";
...
export function SpeakerTasksPage() {
  ...
  const showDate = (value: string | null) => value ? formatEventDateTime(value, timezone) : "No due date";
