...
export function SpeakerPortalPage() {
  ...
  useEffect(() => {
    ...
    if (!section || section === eventSlug) return;
    requestAnimationFrame(() => document.getElementById(`portal-${section}`)?.scrollIntoView({ block: "start" }));
  }, [eventSlug, location.pathname, portal]);
