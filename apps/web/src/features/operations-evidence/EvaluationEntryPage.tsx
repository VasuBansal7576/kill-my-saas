...
export function HelpPage() {
  return <main id="main-content" className={styles.helpPage}>
    ...
    <section className={styles.helpScorecard}><div><p className={styles.eyebrow}>Current contract</p><h2>98 items · 202 weighted points</h2><p>See implementation coverage and fresh release verification as separate states, backed by source-linked evidence.</p></div><Link to="/evaluation-scorecard">Open the public scorecard →</Link></section>
