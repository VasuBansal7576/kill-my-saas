...
export function DashboardPage() {
  ...
  return <div className={styles.workspace}>
    ...
    <section className={styles.metrics} aria-label="Event lifecycle metrics">
      ...
      <Metric label="Decisions" value={dashboard.decisions.accepted + dashboard.decisions.rejected} note={`${dashboard.decisions.undecided} undecided · ${dashboard.decisions.notified} notified`} to={`${base}/submissions`} />
      ...
      <Metric label="Communications" value={`${dashboard.communications.deliveryRate}%`} note={`${dashboard.communications.successful} successful · ${dashboard.communications.failed} failed`} to={`${base}/communications`} progress={dashboard.communications.deliveryRate} danger={dashboard.communications.failed > 0} />
