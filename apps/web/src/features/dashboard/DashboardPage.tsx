...
function buildWorkQueue(data: DashboardSnapshot): WorkItem[] {
  ...
  else if (data.communications.undelivered > 0) items.push({ tone: "violet", code: "CM", title: `${data.communications.undelivered} communication${data.communications.undelivered === 1 ? " is" : "s are"} not delivered`, detail: `${data.communications.inFlight} queued or sending`, label: "Track delivery", to: `${base}/communications` });
