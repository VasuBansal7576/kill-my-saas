...
export function SpeakerFilesPage() {
  ...
  async function upload(row: Deliverable, file: File) {
    ...
    try {
      ...
      setMessage(`${file.name} finalized as immutable v${row.latestVersion + 1}.`); await load();
